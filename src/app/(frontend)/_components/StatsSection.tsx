...
export function StatsSection() {
    return (
        <section className="bg-slate-900 text-white py-16 w-full italic">
            <div className="section-container grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 text-center divide-x divide-white/10 uppercase font-black">
