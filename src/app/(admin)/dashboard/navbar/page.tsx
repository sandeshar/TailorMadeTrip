...
type ContentType = 'packages' | 'notices' | 'teachers' | 'blog';
...
export default function NavbarManager() {
    ...
    const [selectedContentType, setSelectedContentType] = useState<ContentType>('packages');
        ...
        try {
            ...
            switch (type) {
                ...
                case 'blog':
                    ...
                    subs = await CategoryActions.getBlogSubcategories();
                    break;
                default:
                    cats = [];
                    subs = [];
    ...
    const attachSelectedCategories = () => {
        ...
        selectedCategories.forEach(catId => {
            ...
            const getHref = (type: ContentType, cSlug: string, sSlug?: string) => {
                ...
                if (type === 'packages') {
                    return sSlug ? `/packages/${cSlug}/${sSlug}` : `/packages/${cSlug}`;
                }
                if (sSlug) {
                                            ...
                                            {activeTab === 'import' ? (
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex gap-1 overflow-x-auto no-scrollbar pb-1">
                                                        {(['packages', 'notices', 'teachers', 'blog'] as ContentType[]).map(type => (
                                                            <button
                                                                key={type}
                        ...
                        <div className="p-6 space-y-4 overflow-y-auto">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g., Home, About, Packages"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g., /, /about, /packages"
                                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                                />
                            </div>
