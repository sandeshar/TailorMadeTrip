...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { label: "Published Articles", value: stats.articles, icon: "article", color: "bg-green-600", link: "/dashboard/blog" },
  ...
  const quickActions = [
    { label: "New Article", icon: "add_circle", href: "/dashboard/blog/new", color: "text-blue-600" },
