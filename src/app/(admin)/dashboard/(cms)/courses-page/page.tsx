...
export default function PackagePageCMS() {
    ...
    const defaultConfig: IPackageConfig = {
        name: "New Config",
        slug: "new-slug",
        type: 'category',
        hero: {
    ...
    const renderHeroEditor = (config: IPackageConfig, index: number, data: any, setData: (data: any) => void) => {
        ...
        return (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <CMSSection title="Packages Grid">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        const newCategories = [...data.categories];
                                        const currentPackages = newCategories[index].Packages || { title: "", subtitle: "", items: [] };
                                        newCategories[index].Packages = { ...currentPackages, title: e.target.value };
                                        setData({ ...data, categories: newCategories });
                                    }}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        const newCategories = [...data.categories];
                                        const currentPackages = newCategories[index].Packages || { title: "", subtitle: "", items: [] };
                                        newCategories[index].Packages = { ...currentPackages, subtitle: e.target.value };
                                        setData({ ...data, categories: newCategories });
                                    }}
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl"
                                />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    const newCategories = [...data.categories];
                                                    const items = [...(newCategories[index].Packages?.items || [])];
                                                    items[idx] = { ...items[idx], level: e.target.value };
                                                    newCategories[index].Packages = { ...newCategories[index].Packages, items };
                                                    setData({ ...data, categories: newCategories });
                                                }}
                ...
                <CMSSection title="Body Content">
                    <p className="text-sm text-gray-500 mb-6">
                        This content will appear below the hero section. Use the rich text editor to add Package details, syllabus, or other relevant information.
                    </p>
                    <RichTextEditor
                        ...
                        placeholder="Write detailed Package information here..."
                    />
                </CMSSection>
                    ...
                    <div className="w-full lg:w-72 shrink-0">
                        <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm sticky top-8">
                            ...
                            <div className="space-y-1 max-h-[calc(100vh-250px)] overflow-y-auto pr-1 scrollbar-hide">
                                {data.categories.map((config: IPackageConfig, index: number) => (
                                    <button
                                        key={index}
                                        type="button"
