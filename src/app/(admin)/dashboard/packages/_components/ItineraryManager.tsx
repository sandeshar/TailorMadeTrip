                    ...
                    {value.map((item, index) => (
                        <div key={index} className="bg-gray-50 rounded-2xl border border-gray-100 overflow-hidden">
                            <div className="px-6 py-3 bg-white border-b border-gray-100 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <input
                                        ...
                                        className="bg-transparent border-none outline-none font-bold text-gray-900 placeholder:text-gray-300 w-64 md:w-96"
                                    />
                                </div>
                            ...
                            <div className="p-6 space-y-4">
                                <div>
                                    <label className="block text-[10px] uppercase font-bold text-gray-400 mb-1 tracking-wider">Activities & Description</label>
                                    <textarea
                                        rows={3}
                                        value={item.content}
                                ...
                                <div>
                                    <label className="block text-[10px] uppercase font-bold text-gray-400 mb-1 tracking-wider flex items-center gap-1">
                                        <MaterialSymbol icon="lightbulb" size={12} className="text-amber-500" />
                                        Pro Tip (Optional)
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        placeholder="e.g. Best photo spot is near the old temple"
                                        className="w-full px-4 py-2 bg-white border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                                    />
                                </div>
                            </div>
                        </div>
