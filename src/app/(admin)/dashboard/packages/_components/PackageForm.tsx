    ...
    return (
        <div className="max-w-5xl mx-auto pb-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Tea House Trek"
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Hotel or Lodge"
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                />
                            </div>
                        </div>
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-8">
                    <h2 className="text-xl font-bold text-gray-900 border-b pb-4">Media Gallary</h2>
                    <ImageUploader
                        label="Main Image"
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-8">
                    ...
                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Description (Full Rich Text Content)</label>
                            <RichTextEditor
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-all font-sans"
                                rows={3}
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-8">
                    <h2 className="text-xl font-bold text-gray-900 mb-6 border-b pb-4">Detailed Itinerary</h2>
                    <ItineraryManager
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-4">
                    ...
                    >
                        {showSEO ? "Hide" : "Edit"} SEO Settings
                    </button>
