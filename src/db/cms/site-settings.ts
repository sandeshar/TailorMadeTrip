...
const SiteSettingsSchema: Schema = new Schema({
    siteName: { type: String, default: 'Trailor my trip' },
    ...
    seo: {
        title: { type: String, default: "Trailor my trip" },
        description: { type: String, default: "Your Target to Chartered Accountancy Success" },
        titleTemplate: { type: String, default: "%s | Trailor my trip" }
    },
    smtp: {
        ...
        fromName: { type: String, default: 'Trailor my trip' }
    }
}, {
    timestamps: true
});
